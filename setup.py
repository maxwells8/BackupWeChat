...
PACKAGENAME = 'backupwechat'
PYPINAME = 'backupwechat'

GITHUB_BASE = 'https://github.com'
GITHUB_USER = 'maxwells8'
GITHUB_NAME = 'backupwechat'

LICENSE = 'MIT'

KEYWORDS = ['backup', 'wechat', '微信', 'file',
            'picture']

REQUIREMENTS = ['ahk', 'pillow', 'pypiwin32']
PYTHON_VERSION = '>=3.6'

DESCRIPTION = 'backup wechat to friends to file '
